...
Models are accessed through virtual arrays that provide O(1) random access to infinite
...
Virtual array providing O(1) access to infinite User objects.
...
Virtual array providing O(1) access to infinite Address objects.
