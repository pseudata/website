...
description: Learn how to add new data models and their corresponding virtual arrays to Pseudata using TypeSpec definitions.
sidebar:
  order: 1
head:
  - tag: script
...
The generated array classes provide O(1) access to deterministic instances:
