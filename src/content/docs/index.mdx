...
<CardGrid>
  <Card title="Cross-Language Consistency" icon="approve-check">
    Same seed = same data across all languages. No more integration test mismatches. [Learn more →](/advanced/concept/#cross-language-consistency)
  </Card>
  <Card title="Infinite Scale" icon="rocket">
    $O(1)$ instant access to billions of records with zero memory overhead. [Learn more →](/advanced/pseudo-arrays/)
  </Card>
