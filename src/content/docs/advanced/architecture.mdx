...
This page provides a technical explanation of Pseudata's architecture, core components, and design decisions. For a high-level overview, see the [Concept](/advanced/concept/) page. For implementation details, see the [Contributing guides](/contributing/).
