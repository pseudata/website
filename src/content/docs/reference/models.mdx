...
Models are accessed through PseudoArrays that provide $O(\log n)$ random access to infinite
...
|-------|------|-------------|
| `id` | `string` | Deterministic, sortable PseudoID for this user object. |
...
PseudoArray providing $O(\log n)$ access to infinite User objects.
...
PseudoArray providing $O(\log n)$ access to infinite Address objects.
