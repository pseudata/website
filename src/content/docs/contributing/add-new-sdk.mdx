...
6. **Primitives** - ~35 data generation methods
...
- **Large file**: ~3000 lines, 200KB+, generated from ~50 resource files
...
model User {
    ...
    @generator("birthdate") birthdate: string;
    ...
    @generator("updatedAt") updated_at: int32;
}
```
...
- 12 test cases covering all ~35 primitive methods
...
- [ ] **CI**: Added to GitHub Actions workflow
...
1. Create PR with SDK in `sdks/your-language/`
2. Update main README.md with language listing
3. Add CI workflow in `.github/workflows/`
4. Update cross-language compatibility matrix
